...
EXEC_CAT = cat_t
OBJ_CAT = src/main/cat_main.o src/copy.o
...
EXEC_MV = mv_t
OBJ_MV = src/main/mv_main.o src/move.o src/utils/init_header.o src/utils/fonctions_utiles.o src/utils/utils_string.o
...
.PHONY = clean
clean:
	rm $(OBJ) src/execs/ls_t src/execs/cat_t src/execs/mv_t src/execs/pwd_t
